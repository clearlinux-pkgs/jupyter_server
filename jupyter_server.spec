...
Source0  : https://files.pythonhosted.org/packages/6b/14/de66bea38429a58752b2d0236521e6957673846f5454a317daffb8587139/jupyter_server-1.10.1.tar.gz
...
%prep
%setup -q -n jupyter_server-1.10.1
cd %{_builddir}/jupyter_server-1.10.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627050612
...
cp %{_builddir}/jupyter_server-1.10.1/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
