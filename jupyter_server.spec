...
Version  : 1.2.0
Release  : 3
URL      : https://files.pythonhosted.org/packages/e4/2e/67f47316af9a0478a4684268d7d31f6638d2eb1737c4b6b942a5b570d24b/jupyter_server-1.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/e4/2e/67f47316af9a0478a4684268d7d31f6638d2eb1737c4b6b942a5b570d24b/jupyter_server-1.2.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.2.0
cd %{_builddir}/jupyter_server-1.2.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610129091
...
cp %{_builddir}/jupyter_server-1.2.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
