...
Source0  : https://files.pythonhosted.org/packages/b9/a9/e1965c0eaeb7b1c933cb4d0ba9e324d4f7b263a43d399bcdc10c4aa37788/jupyter_server-1.11.2.tar.gz
...
%prep
%setup -q -n jupyter_server-1.11.2
cd %{_builddir}/jupyter_server-1.11.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635862204
...
cp %{_builddir}/jupyter_server-1.11.2/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
