...
Version  : 1.13.0
Release  : 32
URL      : https://files.pythonhosted.org/packages/ab/35/190d2861f26c6d793893a8d1ac8a3bcc3639772e7c6c5d2a21f6f29d19e2/jupyter_server-1.13.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/ab/35/190d2861f26c6d793893a8d1ac8a3bcc3639772e7c6c5d2a21f6f29d19e2/jupyter_server-1.13.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.13.0
cd %{_builddir}/jupyter_server-1.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638887315
...
cp %{_builddir}/jupyter_server-1.13.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
