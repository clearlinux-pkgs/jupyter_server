...
Source0  : https://files.pythonhosted.org/packages/ed/0e/613b6e407dc3cdf82d14824915057bb176fa968e20d7e35c2e95f96d5842/jupyter_server-1.11.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.11.0
cd %{_builddir}/jupyter_server-1.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631206586
...
cp %{_builddir}/jupyter_server-1.11.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
