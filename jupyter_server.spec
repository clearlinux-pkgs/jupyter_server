...
Version  : 1.12.0
Release  : 30
URL      : https://files.pythonhosted.org/packages/15/40/4735fa95083048b5c654b77444644c4984b28844057648b959705d0d135f/jupyter_server-1.12.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/15/40/4735fa95083048b5c654b77444644c4984b28844057648b959705d0d135f/jupyter_server-1.12.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.12.0
cd %{_builddir}/jupyter_server-1.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637681865
...
cp %{_builddir}/jupyter_server-1.12.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
