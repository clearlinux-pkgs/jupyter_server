...
Version  : 1.9.0
Release  : 19
URL      : https://files.pythonhosted.org/packages/2b/31/39198a881669cab5ef94c4baa6b9c873d998604960fac0d8f5f209087874/jupyter_server-1.9.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/2b/31/39198a881669cab5ef94c4baa6b9c873d998604960fac0d8f5f209087874/jupyter_server-1.9.0.tar.gz
...
BuildRequires : pyzmq
BuildRequires : requests-unixsocket
...
Requires: pypi(pyzmq)
Requires: pypi(requests_unixsocket)
...
%prep
%setup -q -n jupyter_server-1.9.0
cd %{_builddir}/jupyter_server-1.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624555425
...
cp %{_builddir}/jupyter_server-1.9.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
