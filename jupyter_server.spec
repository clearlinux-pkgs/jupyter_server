...
Source0  : https://files.pythonhosted.org/packages/ea/0e/cc2d32465af4420cb741a17b61790dcada1b66e454be072ef3b111ac6a07/jupyter_server-1.6.1.tar.gz
...
%prep
%setup -q -n jupyter_server-1.6.1
cd %{_builddir}/jupyter_server-1.6.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618325738
...
cp %{_builddir}/jupyter_server-1.6.1/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
