...
Source0  : https://files.pythonhosted.org/packages/a5/c9/598bb365be05b65184b2bf62ae4f66a5dd61a10f3bf955477e730c3619fd/jupyter_server-1.2.1.tar.gz
...
%prep
%setup -q -n jupyter_server-1.2.1
cd %{_builddir}/jupyter_server-1.2.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610144301
...
cp %{_builddir}/jupyter_server-1.2.1/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
