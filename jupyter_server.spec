...
Source0  : https://files.pythonhosted.org/packages/93/13/fbcf7e678b9eeedda0899a9b77bb93ad49b96cf05065cf3a1f3b312927ab/jupyter_server-1.10.2.tar.gz
...
%prep
%setup -q -n jupyter_server-1.10.2
cd %{_builddir}/jupyter_server-1.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628001899
...
cp %{_builddir}/jupyter_server-1.10.2/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
