...
Source0  : https://files.pythonhosted.org/packages/d8/1b/0beca40d3c64abe3862351a21a8db0dd4e359ba73cc9dc8304590ec730c3/jupyter_server-1.6.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.6.0
cd %{_builddir}/jupyter_server-1.6.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617893679
...
cp %{_builddir}/jupyter_server-1.6.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
