...
Version  : 1.5.1
Release  : 11
URL      : https://files.pythonhosted.org/packages/61/cb/61b144edbca9314c95c7b67c9bce8a5aabec43d4946c43366301de51befb/jupyter_server-1.5.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/61/cb/61b144edbca9314c95c7b67c9bce8a5aabec43d4946c43366301de51befb/jupyter_server-1.5.1.tar.gz
...
%prep
%setup -q -n jupyter_server-1.5.1
cd %{_builddir}/jupyter_server-1.5.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616686260
...
cp %{_builddir}/jupyter_server-1.5.1/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
