...
Source0  : https://files.pythonhosted.org/packages/91/ba/051592cc9478f1674d0d4dc20d57878f89d209972f455ae744c4f492d7de/jupyter_server-1.2.2.tar.gz
...
%prep
%setup -q -n jupyter_server-1.2.2
cd %{_builddir}/jupyter_server-1.2.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610731188
...
cp %{_builddir}/jupyter_server-1.2.2/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
