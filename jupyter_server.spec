...
Version  : 1.4.0
Release  : 8
URL      : https://files.pythonhosted.org/packages/e8/eb/e2508a03d5ab27a54e82bd102703d77f62a8102e1803dc9dc477f542d319/jupyter_server-1.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/e8/eb/e2508a03d5ab27a54e82bd102703d77f62a8102e1803dc9dc477f542d319/jupyter_server-1.4.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.4.0
cd %{_builddir}/jupyter_server-1.4.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613748548
...
cp %{_builddir}/jupyter_server-1.4.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
