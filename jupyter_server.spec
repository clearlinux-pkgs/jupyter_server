...
Source0  : https://files.pythonhosted.org/packages/0e/52/8214fbfeba5b07adac4dc232d5f35d7846f3bfb14b92fe8c9c60eb655cfb/jupyter_server-1.7.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.7.0
cd %{_builddir}/jupyter_server-1.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620753361
...
cp %{_builddir}/jupyter_server-1.7.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
