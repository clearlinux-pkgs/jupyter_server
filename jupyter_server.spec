...
Source0  : https://files.pythonhosted.org/packages/1e/b7/507cdd40692b93305ab75306dc90dab0b96f54deac2d8c1efaeceeb8c4ab/jupyter_server-1.4.1.tar.gz
...
%prep
%setup -q -n jupyter_server-1.4.1
cd %{_builddir}/jupyter_server-1.4.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614096915
...
cp %{_builddir}/jupyter_server-1.4.1/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
