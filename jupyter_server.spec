...
Source0  : https://files.pythonhosted.org/packages/20/e1/562cc8c2ab4bba29c550040f59a81dbb4c592df667626cd994fce735793d/jupyter_server-1.2.3.tar.gz
...
%prep
%setup -q -n jupyter_server-1.2.3
cd %{_builddir}/jupyter_server-1.2.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611971135
...
cp %{_builddir}/jupyter_server-1.2.3/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_server/4864371bd27fe802d84990e2a5ee0d60bb29e944
